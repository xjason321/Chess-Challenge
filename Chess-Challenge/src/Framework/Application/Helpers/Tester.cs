    ...
    public static class Tester
    {
        ...
        public static void RunPerft()
        {
            ...
            for (int i = 0; i < fens.Length; i++)
            {
                ...
                boardAPI = new(board);
                System.Diagnostics.Stopwatch swInner = System.Diagnostics.Stopwatch.StartNew();
                ...
                {
                    Console.WriteLine(i + " successful: " + swInner.ElapsedMilliseconds + " ms");
                }
        ...
        {
            API.Move[] moves = boardAPI.GetLegalMoves();
